 ...
 */
public class TelaManutencaoFuncionario extends javax.swing.JFrame {

    /**
     * Creates new form TelaManutencaoFuncionario
     */
    private ControleFuncionario contFuncionario;
    private List<Funcionario> listaFuncionarios = new ArrayList<Funcionario>();
    private int click = 0;
    
    public TelaManutencaoFuncionario() {
        contFuncionario = new ControleFuncionario();
        initComponents();
        atualizarTabela(contFuncionario.listarTodos());
    }
    
    public void atualizarTabela(List<Funcionario> lista) {
        DefaultTableModel modeloTabela;
        modeloTabela = (DefaultTableModel) tabFuncionario.getModel();
        ...
        for (Funcionario f : this.listaFuncionarios) {
            modeloTabela.addRow(new Object[]{f.getCpf(), f.getNome(), f.getTelefone(), f.getEmail()});
        }
    }
    ...
    private void initComponents() {
        ...
        if (tabFuncionario.getColumnModel().getColumnCount() > 0) {
            tabFuncionario.getColumnModel().getColumn(0).setPreferredWidth(50);
            tabFuncionario.getColumnModel().getColumn(1).setPreferredWidth(100);
            tabFuncionario.getColumnModel().getColumn(2).setPreferredWidth(50);
            tabFuncionario.getColumnModel().getColumn(3).setPreferredWidth(100);
        }
    ...
    private void painelBotNovoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_painelBotNovoMouseClicked
        ...
        if (of.isConfirmou()) {
            contFuncionario.salvar(of.getFuncionario());
            atualizarTabela(contFuncionario.listarTodos());
        }
    ...
    private void painelBotAlterarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_painelBotAlterarMouseClicked
        ...
        if (linha == -1) {
            ...
            if(of.isConfirmou()){
                contFuncionario.alterar(of.getFuncionario());
                atualizarTabela(contFuncionario.listarTodos());
            }
        }
    ...
    private void painelBotExcluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_painelBotExcluirMouseClicked
        ...
        if (linha == -1) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                if(f.getListaCaixas().isEmpty()){
                    contFuncionario.excluir(f);
                    atualizarTabela(contFuncionario.listarTodos());
                } else {
                    JOptionPane.showMessageDialog(this, "Esse funcionário não pode ser excluido");
                }
            }
        }
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        List<Funcionario> LF = contFuncionario.listarPorNomePesquisado(txtPesquisa.getText());
        if (LF.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Nenhum funcionário foi encontrado.");
            atualizarTabela(contFuncionario.listarTodos());
        } else {
            atualizarTabela(LF);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaManutencaoFuncionario().setVisible(true);
            }
        });
    }
